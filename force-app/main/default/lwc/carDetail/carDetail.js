...
export default class CarDetail extends NavigationMixin(LightningElement) {
  ...
  get ownerName() {
    try {
      return this.car.data.fields.Contact__r.value.fields.Name.value;  //to understand this first understand how objects and their fields are related. //similar to accessing soql relationship field __r, 
    } catch (error) {
      return 'NA';
    }
  }
